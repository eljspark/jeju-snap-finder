...
export { Page }; // ✅ Export component separately

export const documentProps = {
  title: "개인정보 처리방침 | 제주스냅파인더",
  description:
    "제주스냅파인더의 개인정보 처리방침. Google AdSense 광고, 쿠키 사용 및 데이터 보호에 대한 안내를 확인하세요.",
};

// ✅ This is the key: vite-plugin-ssr expects a default export object
export default {
  Page,
  documentProps,
};
