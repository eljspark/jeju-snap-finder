...
function generateMetaTags(urlPathname: string, staticData: any) {
  ...
  if (urlPathname.startsWith('/category/') && staticData.occasionFilter) {
    ...
    const categoryTitleMap: Record<string, string> = {
      '커플': '제주 커플스냅 비교하기 | 30개 이상의 스냅 패키지를 가격별로 찾을 수 있어요',
      '가족': '제주 가족 스냅 비교하기 | 30개 이상의 스냅 패키지를 가격별로 찾을 수 있어요',
      '우정': '제주 우정스냅 비교하기 | 30개 이상의 스냅 패키지를 가격별로 찾을 수 있어요',
      '만삭': '제주 만삭스냅 비교하기 | 30개 이상의 스냅 패키지를 가격별로 찾을 수 있어요',
      '아기': '제주 아기스냅 비교하기 | 30개 이상의 스냅 패키지를 가격별로 찾을 수 있어요',
    };
